...
describe "#using_first" do
  it "takes in argument of an array and returns the first element in the array" do
    array = ["wow", "I", "am", "really", "learning", "arrays!"]
...
describe "#using_last" do
  it "takes in argument of an array and returns the last element in the array" do
    array = ["wow", "I", "am", "really", "learning", "arrays!"]
...
describe "#using_size" do
  it "takes in argument of an array and returns the size, or length, of the array" do
    array = ["wow", "I", "am", "really", "learning", "arrays!"]
